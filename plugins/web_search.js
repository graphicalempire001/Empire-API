...
Example: *${prefix}search nodejs tutorials*` 
    ...
    try {
        await sock.sendMessage(chatJid, { text: "🔍 Seconst axios = require('axios');
...
Example: *${prefix}search nodejs tutorials*` 
    ...
    try {
        ...
        // Simple parsing of HTML snippets using regex (unescaped quotes, escaped forward slash in closing tag)
